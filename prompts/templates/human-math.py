...
"""),
    math2code=HumanMessagePromptTemplate.from_template("""The following are some experience you gathered on a similar task of question answering. Use these as references to help you perform this task:
{rules}
"""),
