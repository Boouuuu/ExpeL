...
(4) Finish[code], which is necessary and requires to complete the Python code (including function definition with type hints, docstring, and complete implementation logic) and ends the task.
