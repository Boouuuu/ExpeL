...
Insights_Path = r"C:\Users\HUAWEI\Desktop\ExpeL\logs\math2code_math\expel\extracted_insights\fold_0\insights-mathscode-run-glm-expel.txt"
...
def run_transfer_and_eval() -> None:
    ...
    # )
    finetued_insights = "Always begin by analyzing the problem structure to identify the core logic branches and requirements. Break down your solution into clear, sequential steps: initialize necessary variables, process the main logic with explicit loops or conditions, and handle edge cases separately. Test your approach with the provided examples to verify correctness before finalizing. When implementing, use clear variable names and ensure each step performs a single, well-defined operation. After completing the main logic, verify your solution handles all edge cases and matches the expected outputs exactly. Keep your code readable and maintainable by avoiding unnecessary complexity and ensuring proper return statements."
    print("\n===== Finetuned Insights =====\n")
