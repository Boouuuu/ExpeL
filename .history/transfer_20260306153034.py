...
Target_Task_File = r"C:\Users\HUAWEI\Desktop\ExpeL\data\math2code\code_tasks.jsonl.jsonl"
...
def judge_action(self, action: str) -> None:
    action_type, argument = parse_action(action)
    if action_type == "Finish":
        submitted_code = (argument or "").strip()
        print("submitted_code:", submitted_code)
        ok, msg = self._run_tests(submitted_code)
