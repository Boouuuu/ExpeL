...
def human_instruction_fewshot_message_prompt(message_type):
    if message_type == 'all_system':
        return SystemMessagePromptTemplate.from_template(human_instruction_fewshots_template)
    else:
        return HumanMessagePromptTemplate.from_template(human_instruction_fewshots_template)
if message_type == 'all_system':
    human_instruction_fewshot_message_prompt = {
            "role": "system",
            "content": human_instruction_fewshots_template,
        }
else:
    human_instruction_fewshot_message_prompt = {
            "role": "human",
