...
#     SystemMessagePromptzzzzTemplate.from_template(
...
if_message_type == 'all_system':
    human_instruction_fewshot_message_prompt = SystemMessagePromptTemplate.from_template(
