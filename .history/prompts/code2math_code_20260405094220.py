...
Thought 1:
This problem involves hashing with a boundary condition. I will implement and verify using tests.
First, I analyze the requirement: this function needs to compute the SHA256 hash of input content and return None when the content is empty. I will use Python's built-in hashlib library, which is the standard tool for SHA256 hashing. The core steps are: first judge if the input content is empty, return None directly if true; otherwise encode the content, generate the SHA256 hash object, get the hexadecimal digest, and return it. I will implement this logic and verify it with empty and non-empty test cases.
...
Thought 2:
All test cases pass, including boundary condition.
...
Thought 1:
This problem involves range normalization and filtering.
...
Thought 3:
All test cases pass after enforcing the valid range constraint.
