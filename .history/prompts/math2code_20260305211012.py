...
SYSTEM_INSTRUCTION = """Solve a code generation problem with interleaving Thought, Action, Observation steps.Thought can reason about the current situation, and Action can be three types:Action can be:
...
def LLM_PARSER(llm_output, step: int, ai_message: bool) -> Tuple[dict, str, Dict[str, Any]]:
    print(f"原始LLM Output: {llm_output}")  # Debug print to see the raw output
