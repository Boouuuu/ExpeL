...
Solve a code generation problem with interleaving Thought, Action, Observation steps.
Thought reasons about the problem at a high level. Before writing detailed code, identify the overall structure, strategy, or reusable pattern of the solution. Focus on reasoning patterns that could be reused across similar programming problems.
Action can be:
...
(4) Finish[code], which gives the final complete function implementation and ends the task.
