...
You should first generate a Thought, then choose an Action. After each Action, STOP generate and wait for Observation from the system to. Do NOT generate Observation by yourself."""
