...
You should first generate a Thought, then choose an Action. After each Action, STOP generate and wait for the system to return . Do NOT generate Observation by yourself."""
