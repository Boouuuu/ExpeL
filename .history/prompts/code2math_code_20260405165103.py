...
You should first generate a Thought, then choose an Action. After each Action, STOP gener and wait for Observation from the system. Do NOT generate Observation by yourself."""
