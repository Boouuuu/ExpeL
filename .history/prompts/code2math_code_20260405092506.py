...
def generate_odd_numbers(x, y):
    \"\"\"
    Given two integers x and y, return all odd numbers between them 
    that lie within 1 to 9 (inclusive). 
...
Thought 1:
I will generate all odd numbers between x and y, assuming x <= y or y <= x.
I might forget to restrict numbers to 1–9.
...
Observation 1:
AssertionError: generate_odd_numbers(10, 12) != []
