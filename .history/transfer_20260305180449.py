...
"""
Target_Task_description = """You are Code problem-solving systemThought reasons about the problem at a high level. Before writing detailed code, identify the overall structure, strategy, or reusable pattern of the solution. Focus on reasoning patterns that could be reused across similar problems.
Action can be:
