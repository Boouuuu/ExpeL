...
Target_Task_description = """You are Code problem-solving system. Solve a question answering task with interleaving Thought, Action, Observation steps. Thought can reason about the current situation, and Action can be three types:
...
(4) Finish[code], which required to complete the Python code (including function definition with type hints, docstring, and complete implementation logic) and ends the task.
    ...
    with open(Target_Task_File, "r", encoding="utf-8") as f_in, \
        ...
        for line in f_in:
            ...
            for step_idx in range(max_steps):
                ...
                # 解析最后一个action
                action_type, action_content = parse_action(completion_text)
