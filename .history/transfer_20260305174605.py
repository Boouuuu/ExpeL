...
"""
Target_Task_description = """Now, based on the above insights, examples, and description, please provide a concise and easy to follow instructional paragraph for the student agent to solve the {Target_Task}. Make sure the paragraph is VERY CONCISE and EASY TO FOLLOW!"""
