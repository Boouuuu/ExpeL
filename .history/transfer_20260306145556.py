...
Target_Task_description = """You are Code problem-solving system. Solve a question answering task with interleaving Thought, Action, Observation steps. Thought can reason about the current situation, and Action can be four types:
